...
const Setup = () => {
    ...
    return (
        <>
            ...
            <HelpTitle>별명 설정 안내</HelpTitle>
            <HelpText>1. 별명은 2 ~ 15글자의 영문자, 한글, 숫자, 공백, 특수문자 -, _로 설정하실 수 있습니다.</HelpText>
            <HelpText>2. 별명은 7일마다 변경하실 수 있으며, 250핑을 사용하여 고정할 수 있습니다.</HelpText>
