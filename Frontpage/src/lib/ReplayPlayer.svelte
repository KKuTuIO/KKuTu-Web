<script>
  ...
  function wordstackPosition(index) {
    const positions = ['①', '②', '③', '④', '⑤', '⑥', '⑦', '⑧', '⑨', '⑩'];
    if (index < 0) return '?';
...
<style>
  ...
  .game-user-wordstack-target { border-color: #56b5f0; background: #e3f5ff; animation: wordstack-target-blink 0.7s ease-in-out infinite; }
