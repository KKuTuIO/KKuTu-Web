...
export const academyClient = {
  ...
  practiceAnswer(config, difficulty, requiredChar, usedWords, word, shields = 0) {
    return call('practiceAnswer', { config, difficulty, requiredChar, usedWords, word, shields });
  },
