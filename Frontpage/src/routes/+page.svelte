                    ...
                    {#await getMoremi(getUserId(authVendor, vendorId)) then equip}
                        {#if equip}
                            ...
                            <div class="flex flex-col">
                                ...
                                <a href="/account" rel="external" class="mt-2 inline-flex w-fit items-center gap-x-1 rounded-full bg-[#55aa55] px-3 py-1 text-sm font-bold text-white transition hover:bg-[#51a351] active:scale-95">
