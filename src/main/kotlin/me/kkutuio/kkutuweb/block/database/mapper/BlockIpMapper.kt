...
package me.kkutuio.kkutuweb.block.database.mapper

import me.kkutuio.kkutuweb.block.BlockIp
import me.kkutuio.kkutuweb.block.PunishFrom
...
class BlockIpMapper : RowMapper<BlockIp> {
    override fun mapRow(rs: ResultSet, rowNum: Int): BlockIp {
        ...
        return BlockIp(id, ipAddress, time, pardonTime, reason, punishFrom, onlyGuestPunish, admin, inquiryId)
    }
}
