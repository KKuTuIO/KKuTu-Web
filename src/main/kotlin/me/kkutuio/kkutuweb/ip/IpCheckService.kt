package me.kkutuio.kkutuweb.ip
...
class IpCheckService {
    private val whitelistMatchers = mapOf(
        ...
        "SK-LTE-3/5G-1/" to IpAddressMatcher("223.32.0.0/11"),
        "SK-5G-2/5" to IpAddressMatcher("211.235.64.0/18"),
        "SK-5G-3/5" to IpAddressMatcher("211.235.128.0/18"),
        ...
        "KT-LTE-4" to IpAddressMatcher("211.246.69.0/24"),

        "LG-3G-1/2" to IpAddressMatcher("61.43.0.0/16"),
        "LG-3G-2/2/LTE-1/5" to IpAddressMatcher("211.234.0.0/17"),
