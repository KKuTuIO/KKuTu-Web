...
class UserDao(
    ...
    fun newUser(id: String, nick: String, similarityNick: String) {
        ...
        kkutuJsonObj.value =
            "{\"score\":0,\"playTime\":0,\"connectDate\":0,\"record\":{\"EKT\":[0,0,0,0,0],\"ESH\":[0,0,0,0,0],\"KKT\":[0,0,0,0,0],\"KSH\":[0,0,0,0,0],\"CSQ\":[0,0,0,0,0],\"KCW\":[0,0,0,0,0],\"KTY\":[0,0,0,0,0],\"ETY\":[0,0,0,0,0],\"KAP\":[0,0,0,0,0],\"HUN\":[0,0,0,0,0],\"KDA\":[0,0,0,0,0],\"EDA\":[0,0,0,0,0],\"KSS\":[0,0,0,0,0],\"ESS\":[0,0,0,0,0],\"ECW\":[0,0,0,0,0]}}"
